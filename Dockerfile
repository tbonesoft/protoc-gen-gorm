...
COPY --from=builder /go/src/github.com/tbonesoft/protoc-gen-gorm/proto /go/src/github.com/tbonesoft/protoc-gen-gorm/proto
...
ENTRYPOINT ["protoc", "-I.", \
    ...
    "-Igithub.com/tbonesoft/protoc-gen-gorm", \
